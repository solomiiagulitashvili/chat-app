...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ \"@babel/runtime/helpers/defineProperty\");\n/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"@babel/runtime/regenerator\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! http */ \"http\");\n/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(http__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var socket_io__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! socket.io */ \"socket.io\");\n/* harmony import */ var socket_io__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(socket_io__WEBPACK_IMPORTED_MODULE_4__);\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_5__);\n/* harmony import */ var _methods_createRoom__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./methods/createRoom */ \"./server/methods/createRoom.js\");\n/* harmony import */ var _methods_getRoomsList__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./methods/getRoomsList */ \"./server/methods/getRoomsList.js\");\n/* harmony import */ var _methods_deleteRoom__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./methods/deleteRoom */ \"./server/methods/deleteRoom.js\");\n/* harmony import */ var _models_messageDb__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./models/messageDb */ \"./server/models/messageDb.js\");\n\n\n\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(source, true).forEach(function (key) { _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\n\n\n\n\n\n\n\n\nvar app = express__WEBPACK_IMPORTED_MODULE_2___default()();\nvar Server = http__WEBPACK_IMPORTED_MODULE_3___default.a.createServer(app);\nvar IO = socket_io__WEBPACK_IMPORTED_MODULE_4___default()(Server, {\n  path: '/api/socket/'\n});\napp.use(express__WEBPACK_IMPORTED_MODULE_2___default.a.json());\n\n(function _callee() {\n  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function _callee$(_context) {\n    while (1) {\n      switch (_context.prev = _context.next) {\n        case 0:\n          _context.next = 2;\n          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(mongoose__WEBPACK_IMPORTED_MODULE_5___default.a.connect('mongodb://localhost:27017/chat-app', {\n            useNewUrlParser: true,\n            useUnifiedTopology: true\n          }));\n\n        case 2:\n        case \"end\":\n          return _context.stop();\n      }\n    }\n  });\n})();\n\napp.post('/api/room/', _methods_createRoom__WEBPACK_IMPORTED_MODULE_6__[\"default\"]);\napp.get('/api/room/', _methods_getRoomsList__WEBPACK_IMPORTED_MODULE_7__[\"default\"]);\napp[\"delete\"]('/api/room/', _methods_deleteRoom__WEBPACK_IMPORTED_MODULE_8__[\"default\"]);\nIO.on('connection', function (socket) {\n  socket.on('room', function (roomId, func) {\n    if (socket.roomId) {\n      socket.leave(socket.roomId);\n    }\n\n    socket.roomId = roomId;\n    socket.join(roomId);\n    _models_messageDb__WEBPACK_IMPORTED_MODULE_9__[\"default\"].find({\n      room: roomId\n    }).sort({\n      datetime: -1\n    }).limit(10).then(function (existantMessages) {\n      return func(existantMessages);\n    });\n  });\n  console.log(socket.id);\n  socket.on('message', function (messageObj, func) {\n    _models_messageDb__WEBPACK_IMPORTED_MODULE_9__[\"default\"].create(_objectSpread({}, messageObj, {\n      datetime: new Date()\n    })).then(function (messageCreated) {\n      _models_messageDb__WEBPACK_IMPORTED_MODULE_9__[\"default\"].find({}, function (err, messages) {\n        console.log(messages);\n        socket[\"in\"](_models_messageDb__WEBPACK_IMPORTED_MODULE_9__[\"default\"].room).broadcast.emit('messages', messages);\n        func(messageCreated);\n      });\n    });\n  });\n});\nvar PORT = process.env.PORT || 8080;\nServer.listen(PORT, function () {\n  console.log(\"App listening to \".concat(PORT, \"....\"));\n});\n\n//# sourceURL=webpack:///./server/index.js?");
